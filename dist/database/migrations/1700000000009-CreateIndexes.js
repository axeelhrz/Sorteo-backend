...
exports.CreateIndexes1700000000009 = void 0;
class CreateIndexes1700000000009 {
    async up(queryRunner) {
        // Índices en tabla raffles
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_raffles_shop_id ON raffles("shopId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_raffles_status ON raffles(status)`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_raffles_created_at ON raffles("createdAt")`);
        // Índices en tabla raffle_tickets
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_raffle_tickets_raffle_id ON raffle_tickets("raffleId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_raffle_tickets_user_id ON raffle_tickets("userId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_raffle_tickets_payment_id ON raffle_tickets("paymentId")`);
        // Índices en tabla payments
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_payments_user_id ON payments("userId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_payments_raffle_id ON payments("raffleId")`);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_shops_user_id ON shops("userId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_shops_status ON shops(status)`);
        // Índices en tabla deposits
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_deposits_raffle_id ON deposits("raffleId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_deposits_status ON deposits(status)`);
        // Índices en tabla audit_logs
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_audit_logs_admin_id ON audit_logs("adminId")`);
...
exports.CreateIndexes1700000000009 = CreateIndexes1700000000009;
