...
exports.ComplaintsModule = ComplaintsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([complaint_entity_1.Complaint, complaint_message_entity_1.ComplaintMessage, complaint_attachment_entity_1.ComplaintAttachment]),
